...
\newcommand{\lecturetitle}{Review of Gears} 

\newcommand{\sectiontitleI}{Overview} % More Titles and Stuff
\newcommand{\sectiontitleII}{Different Types}
\newcommand{\sectiontitleIII}{Law of Gearing}
\newcommand{\sectiontitleIV}{Gears and Loads}
